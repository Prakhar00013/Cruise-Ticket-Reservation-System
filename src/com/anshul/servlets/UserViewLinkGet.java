			...
			if(!uName.equals("")||uName!=null) {
				try {
					...
					if(rs.next()) {
						...
						RequestDispatcher rd = req.getRequestDispatcher("SearchCruises.html");
						rd.include(req, res);
						pw.println("<div class='tab'><p1 class='menu'>Cruise No."+req.getParameter("criusenumber")+" is Not Available !</p1></div>");
					}
				}
				catch(Exception e) {}
