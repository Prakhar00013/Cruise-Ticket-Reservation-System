...
public class CruiseBwPort extends HttpServlet{
				...
				try {
					...
					if(rs.next()) 
					{
						...
						pw.println("<div class='tab'>" + 
								...
								"		</p1>" + 
								"	</div>");
						pw.println("<div class='main'><p1 class='menu'>Cruises BetWeen Port "+req.getParameter("fromport")+" and "+req.getParameter("toport")+"</p1></div>");
