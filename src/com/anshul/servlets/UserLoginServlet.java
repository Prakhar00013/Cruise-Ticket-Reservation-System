...
import com.anshul.beans.UserBean;
			...
			if(rs.next())
			{
			    ...
			    */
				...
				sct.setAttribute("ubean", ub);
					...
					rd.include(req, res);
					pw.println("<div class='main'><p1 class='menu'>Hello "+uName+" ! Welcome to our new NITCTC Website</p1></div>");
					pw.println("<div class='tab'>Hello "+uName+" ! Good to See You here.<br/> Here you can Check up the cruise "
							+ "details and cruise schedule,fare Enquiry and many more information.<br/>Just go to the Side Menu Links and "
