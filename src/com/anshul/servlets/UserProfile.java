		...
		if(ck!=null) {
			...
			if(!uName.equals("")||uName!=null) {
				...
				pw.println("<div class='tab'>" + 
						"		<p1 class='menu'>" + 
						"	Hello "+uName+" ! Welcome to our new NICRTC Website" + 
						"		</p1>" + 
						"	</div>");
				pw.println("<div class='main'><p1 class='menu'><a href='viewuserprofile'>view Profile</a></p1>"
						...
						+ "</div>");
				pw.println("<div class='tab yellow'>Hey ! "+uName+",Welcome to NITCTC<br/><br/>Here You can Edit,View Your Profile and change your PassWord.<br/>"
